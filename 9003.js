		...
		$.getScript(
			...
			function () {
				...
				rev.slick({
					...
					focusOnSelect: true,
					prevArrow:
						'<button class="arrow-left" style="left: 10%;"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M16.707 8.99992L7.12124 8.99992L10.4141 5.70703L8.99993 4.29282L3.29282 9.99992L8.99992 15.707L10.4141 14.2928L7.12124 10.9999L16.707 10.9999L16.707 8.99992Z" fill="black"/></svg></button>',
					nextArrow:
