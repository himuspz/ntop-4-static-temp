			...
			return i.length
				? function (e, t) {
						...
						for (let o of i) {
							if (
								((n = o.field),
								(s = ("desc" === o.direction ? -1 : 1) * P(r(n, e), r(n, t))))
							)
								return s;
						}
						return 0;
	...
	class ue extends (function (e) {
		...
		constructor(e, t) {
			...
			if (
				...
				n.controlInput
					? ((p = V(n.controlInput)), (this.focus_node = p))
					: ((p = V("<input/>")), (this.focus_node = l));
			(this.wrapper = r),
				(this.dropdown = a),
		...
		onKeyDown(e) {
			...
			if (((t.ignoreHover = !0), t.isLocked)) 9 !== e.keyCode && se(e);
				...
				switch (e.keyCode) {
					case 65:
						if (oe(W, e) && "" == t.control_input.value)
							return se(e), void t.selectAll();
						break;
					case 27:
						return (
					...
					case 9:
						return void (
							...
							(t.canSelect(t.activeOption) &&
								(t.onOptionSelect(e, t.activeOption), se(e)),
							t.settings.create && t.createItem() && se(e))
						);
					case 8:
					case 46:
		...
		clearActiveOption() {
			this.activeOption &&
				(z(this.activeOption, "active"),
				G(this.activeOption, { "aria-selected": null })),
				(this.activeOption = null),
		...
		refreshOptions(e = !0) {
			...
			if (
				...
				e && !h.isOpen && (h.open(), h.scrollToOption(y, "auto")),
					h.setActiveOption(y);
		...
		getItem(e) {
			...
			var t = Y(e);
			return null !== t
				? this.control.querySelector(`[data-value="${le(t)}"]`)
				: null;
		}
		addItems(e, t) {
			var i = this,
		...
		updateOriginalInput(e = {}) {
			...
			if (t.is_select_tag) {
				...
				function o(i, s, o) {
					return (
						i ||
							(i = V('<option value="' + ee(s) + '">' + ee(o) + "</option>")),
		...
		deleteSelection(e) {
			...
			for (se(e, !0), void 0 !== s && r.setCaret(s); l.length; )
				r.removeItem(l.pop());
		...
		ue.define("checkbox_options", function () {
			...
			e.hook("after", "setupTemplates", () => {
				...
				e.settings.render.option = (i, s) => {
					...
					return (
						r && e.items.indexOf(r) > -1 && (o.checked = !0), n.prepend(o), n
					);
				};
			}),
				e.on("item_remove", (t) => {
				...
				e.on("initialize", () => {
					e.control_input.addEventListener("keydown", (t) => {
						switch (t.keyCode) {
							case 27:
								return (
									e.isOpen && (se(t, !0), e.close()), void e.clearActiveItems()
								);
							case 9:
								e.focus_node.tabIndex = -1;
						}
